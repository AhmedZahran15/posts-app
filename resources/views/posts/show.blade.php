                    ...
                    <div class="mb-10 bg-gray-50 rounded-lg p-6 border border-gray-100">
                        ...
                        <form action="{{ route('posts.comments.store', $post) }}" method="POST">
                            ...
                            <div class="flex justify-end">
                                <button type="submit" class="inline-flex items-center px-4 py-2 text-sm font-medium rounded border border-transparent text-white bg-indigo-600 hover:bg-indigo-700 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 focus:outline-none transition duration-150 ease-in-out">
                                ...
                                <div class="flex items-center justify-between mb-4">
                                    ...
                                    @if(Auth::id() == $comment->user_id)
                                        <div class="flex space-x-2">
                                            ...
                                            <form action="{{ route('posts.comments.destroy', ['post' => $post->id, 'comment' => $comment->id]) }}" method="POST" class="inline-block">
                                                @csrf
                                                @method('DELETE')
